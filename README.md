...
화학 → 바이오소재 → 의료·생체신호 → 제조 도메인을 거치며, 데이터를 정제하고 의미를 끌어내는 일을 일관된 관점으로 확장해 왔습니다. 
현재는 소규모 팀에서 글로벌 B2B, D2C 자사몰 구축(shopify), 카메라 기반 제품 인식 웹앱 개발, 원가 산정 대시보드, SNS 자동화 구축 설계 진행 중에 있습니다. 
또한 기존 제조업 부서 관련 사람이 반복적인 업무를 보조할 수 있는 자동화 프로그램 및 시스템을 설계 구축 하고 있습니다. - 회계 Dynamic 365 ERP 업로드 분장 자동화
...
- 4인 팀원 소규모 운영 프로젝트
- **제10회 KOREA OPEN** — 10개국 참가, 약 **4,000명** 참가 선수 및 경기 진행 라이브 중계 서비스 운영 담당
- 프론트엔드 외 구축·설계 전 과정 공동 담당
- [everyplay.weplaykorea.com](https://everyplay.weplaykorea.com/)
