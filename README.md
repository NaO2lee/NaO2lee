...
안녕하세요, NaO2 입니다. 
현재 AI를 활용하여 분석 맞춤형 서비스를 구축하는 업무를하고 있습니다.

현재 AI팀에서 크게 두 가지 업무를 수행하고 있습니다.
1. 화장품 제조업: 각 부서 반복되는 업무 생산 공정 최적화 AI 에이전트 개발, ERP 자동화 포털 구축
2. 신사업 뷰티브랜드 플랫폼 : 글로벌 D2C 이커머스 구축(Shopify 기반), 제품 AR 정보 안내 웹앱 개발, SNS 마케팅 자동화 기획 중

### 외부 활동
모두의 플레이 — 제 10회 Korea Open 2026 라이브 스트리밍 경기 중계서비스 운영

### 학력 논문 개제: AI·빅데이터 석사(GPA 4.25/4.5)를 졸업
IEEE Access 1저자 논문(PPG 기반 연속 혈압 추정, 2024)과 Robotics(MDPI) 공저
- 수상 내역 : 한국컴퓨터정보학회 우수논문상, EBRC & HOME 우수논문상, 2023 천안문화도시 리빙랩 페어 3위
- 자기 활동 내역: 아산시 청년동아리 3.14 지원사업 팀장, 충청남도 보통의 혁신가
- 이전 직무 활동: 순천향대학교 산학협력단 정신건강연구센터 AI·IoT 기반정신질환자 응급상황 예측시스템
KIOST 해저공간 창출·활용 기술 개발(3차년도)에 참여
...
- 4인 팀원 소규모 운영 프로젝트
- 기간 / 역할 2026.05.01 ~ 05.03 · 라이브 운영 + 프론트엔드 운영 지원
- 목표
3일간 제10회 Korea Open 줄넘기 대회의 다중 코트 라이브 스트리밍, 배치 확인, 선수 경기 영상 추적, 스폰서 노출을 한 시스템에 서 처리
- 구축 / 운영
다중 코트 OBS 동시 녹화·라이브 스트리밍(최대 6개 라이브 진행), YouTube 라이브 타임스탬프 자동 매핑
자동 클립 추출 (heat 단위 시작·종료 시점에서 OBS 녹화 잘라내기) + Google Drive 업로드
스폰서 / 광고 슬롯 운영 (배너, CTA, 이벤트별 가중치)
다종목 동시 출전 선수 매핑 (#571 배번 + event_code 별 entry)
- 성과
누적 요청 540,700건 / 대역폭 37.84 GB — 3일 무중단 처리 (시간당 평균 약 7,500건)
순방문자 8,700명 (Unique) / 페이지뷰 21,000회
글로벌 11개국+ 도달 · 3일차 해외 접속 55.1% (HK 22K, KR 23.8K — 홍콩이 한국과 거의 동률)
YouTube 누적 조회 35,700+ / 총 시청 92.4시간 (3일차 채널 종합)
CTR 24.5% — 유튜브 평균(약 14%) 대비 1.7배, 노출되면 4명 중 1명이 클릭
캐시 효율 14.8% (2.66 GB 절감) — Cloudflare 엣지 캐시 최적화로 원본 서버 부하
7월 경기도협회장배 줄넘기 대회 서비스 운영 계약 완료
...
| 2016 — 2017 | 이화여자대학교 대학원 석사 수료 — 생체무기화학 ([Wonwoo Nam Lab](https://sites.google.com/view/wnamlab/center-for-dioxygen-chemistry)) |
...
- **충남사회혁신센터 / 보통의 혁신가** — 팀장 (2022.04 ~ 2022.12) · 지역 문제 해결형 혁신 프로젝트 · [활동 영상](https://youtu.be/H0IotYKonbI) · [인터뷰 영상](https://youtu.be/lIFndaij0X0)
- **아산시 청년 동아리 / 카사드(CASAD)** — 팀장 (2022.04 ~ 2022.12) · 충남 아산시 지역 홍보 및 캐릭터 굿즈·SNS 소통 제작 · [Instagram](https://www.instagram.com/casad_3.14)
